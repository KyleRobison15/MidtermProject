...
//	}
	...
	@RequestMapping(path = "submitRating.do", method = RequestMethod.POST, params = { "rating", "comment" })
	public ModelAndView submitRating(String rating, String comment, String userId, String beerId) {
		...
		if (user.getRatings().contains(rating1)) {
			ratingDao.updateBeerRating(Integer.valueOf(beerId), Integer.valueOf(userId), Integer.valueOf(rating),
					comment);
			alreadyRated = true;
			System.out.println("----------------------------------------------------------------------");
			...
			System.out.println("----------------------------------------------------------------------");
			// moved up to line 68...
			// ratingDao.updateBeerRating(Integer.valueOf(beerId), Integer.valueOf(userId),
			// Integer.valueOf(rating), comment);
			// rating1 = ratingDao.getRating(ratingId);
			// mv.addObject("userReview", rating1);
		} else {
	...
	@RequestMapping(path = "editRating.do", method = RequestMethod.POST, params = { "rating", "comment" })
	public ModelAndView editRating(String rating, String comment, String userId, String beerId) {
		ModelAndView mv = new ModelAndView();
		...
		mv.addObject("alreadyRated", alreadyRated);
		System.out.println("---------------------------------------------------------------------");
		System.out.println("IN EDIT RATING . DO");
		System.out.println("---------------------------------------------------------------------");
		
		mv.setViewName("beerProfileEdit");
		return mv;
	}
