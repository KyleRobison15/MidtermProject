...
START TRANSACTION;
USE `beer_budsdb`;
INSERT INTO `user` (`id`, `username`, `password`, `first_name`, `last_name`, `email`, `create_date`, `enabled`, `role`, `address_id`, `profile_image_url`) VALUES (1, 'KyleRobison', 'admin1', 'Kyle', 'Robison', 'admin1@example.com', '2017-07-16 12:00:00', 1, 'admin', 2, 'https://droidjournal.com/wp-content/uploads/2020/12/Top_Gun_Tom_Crusie.jpg.jpg');
